				...
				<div class="col-md-6 col-lg-7 p-b-30">
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="wrap-slick3-dots"><ul class="slick3-dots" role="tablist" style=""><li class="slick-active" role="presentation"><img src="{{$product->thumb}}" alt="{{$product->name}}"><div class="slick3-dot-overlay"></div></li></ul></div>
    ...
    <section class="sec-relate-product bg0 p-t-45 p-b-105">
		...
		<div class="container">
			<div class="row autoplay">
				@foreach( $productsmore as $productsmore)
				<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="{{$productsmore->thumb}}" alt="{{$productsmore->name}}">
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="/san-pham/{{$productsmore->id}}-{{Str::slug($productsmore->name,'-')}}.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6" tabindex="0">
                                    {{$productsmore->name}}
									</a>
